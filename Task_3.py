...
# Перезаписываем __str__ у экспертов
...
print()
# перезаписываем __str__ у лекторов
...
# Перезаписываем __str__ у студентов
...
# Сравниваем средний балл у лекторов
...
# Сравниваем средний балл у студентов
